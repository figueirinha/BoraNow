...
namespace Recodme.RD.BoraNow.PresentationLayer.WebAPI.Controllers.Api.Users
{
    ...
    public class ProfileController : ControllerBase
    {
        ...
        {
            var profile = new Profile(vm.Description, vm.PhotoPath);
        ...
        public ActionResult Update([FromBody] ProfileViewModel vm)
        {
            ...
            if (current.Description == vm.Description && current.PhotoPath == vm.PhotoPath) return new ObjectResult(HttpStatusCode.NotModified);
