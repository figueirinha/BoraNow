...
namespace Recodme.RD.BoraNow.BusinessLayer.BusinessObjects.Users
{
    ...
    {
        private ProfileDataAccessObject _dao;
        ...
        #region Create
        public OperationResult Create(Profile profile)
        {
            try
            {
        ...
        public async Task<OperationResult> UpdateAsync(Profile profile)
        {
            try
            {
        ...
        #region Delete
        public OperationResult Delete(Profile profile)
        {
            try
            {
                _dao.Delete(profile);
        ...
        public async Task<OperationResult> DeleteAsync(Profile profile)
        {
            try
            {
