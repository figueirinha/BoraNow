...
namespace Recodme.RD.BoraNow.BusinessLayer.BusinessObjects.Users
{
    ...
    {
        private CompanyDataAccessObject _dao;
        ...
        #region Create
        public OperationResult Create(Company company)
        {
            try
            {
        ...
        public async Task<OperationResult> CreateAsync(Company company)
        {
            try
            {
                await _dao.CreateAsync(company);
                return new OperationResult() { Success = true };
            }
            catch (Exception e)
            {
        ...
        public async Task<OperationResult> UpdateAsync(Company company)
        {
            try
            {
                await _dao.UpdateAsync(company);
                return new OperationResult() { Success = true };
            }
            catch (Exception e)
            {
        ...
        #region Delete
        public OperationResult Delete(Company company)
        {
            try
            {
                _dao.Delete(company);
        ...
        public async Task<OperationResult> DeleteAsync(Company company)
        {
            try
            {
                await _dao.DeleteAsync(company);
                return new OperationResult() { Success = true };
            }
            catch (Exception e)
            {
